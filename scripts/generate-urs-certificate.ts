...
const rootSeed = new Uint8Array(32).fill(0x82);
const certAuthority = ml_dsa65.keygen(rootSeed);

const certificatePayload = {
  protocol: 'Algorand-Launchpad-AlgoQain-PQC',
  ...
  truthTaxonomy: {
    ...
    smartContractStandard: 'ALGORAND_TEAL_5_ESCROW',
    backendFramework: 'FASTAPI_PYTHON_INDEXER',
